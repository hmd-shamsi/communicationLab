//chooses images present in file
const images = document.querySelectorAll('.images img');

//smooth scroll referenced from 'QuickCodingTuts'
window.addEventListener('scroll', () => {

  //move the images in a way making farther objects move slower and closer move faster
